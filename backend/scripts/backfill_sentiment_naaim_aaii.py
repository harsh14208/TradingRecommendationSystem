#!/usr/bin/env python3
"""§106a — Backfill NAAIM + AAII sentiment panels.
...
from services.sentiment_naaim_aaii import download_naaim_panel, download_aaii_panel
