...
async def news_worker(
    ...
    if avg_sent > 0.25:
        ...
        result.rationale.append({
            "src": lbl, "head": top["headline"][:90],
            "body": top.get("summary", top["headline"])[:250],
            "sentiment": "pos", "meta": meta,
        })
    elif avg_sent < -0.25:
...
async def fundamentals_worker(
    ...
    if f is not None:
        ...
        if f >= 7:
            result.score += 12
            result.rationale.append({"src": "Fundamentals",
                ...
                "sentiment": "pos", "meta": f"F-Score: {f}/9"})
        elif f >= 5:
            result.score += 5
        elif f <= 2:
            result.score -= 10
            result.rationale.append({"src": "Fundamentals",
                ...
                "sentiment": "neg", "meta": f"F-Score: {f}/9"})
        elif f <= 4:
            result.score -= 4
    ...
    if fcf is not None:
        ...
        if fcf > 8:
            ...
            result.rationale.append({"src": "Fundamentals",
                ...
                "sentiment": "pos", "meta": f"FCF Yield: {fcf:.1f}%"})
        elif fcf > 4:
            result.score += 4
        elif fcf < 0:
            result.score -= 6
            result.rationale.append({"src": "Fundamentals",
                ...
                "sentiment": "neg", "meta": f"FCF Yield: {fcf:.1f}%"})
    ...
    try:
            ...
            if t10y:
                ...
                if gap > 1.0:
                    ...
                    result.rationale.append({"src": "Fundamentals",
                        ...
                        "sentiment": "pos", "meta": f"Yield gap: +{gap:.1f}pp"})
                elif gap < -2.0:
                    result.score -= 3
        ...
        if aristo:
            ...
            result.rationale.append({"src": "Fundamentals",
                ...
                "sentiment": "pos", "meta": f"div_{aristo.lower()}={yrs}yr +{pts}pts"})
    except Exception:
        pass
    ...
    try:
        ...
        if ann.get("revenue_torpedo"):
            ...
            result.rationale.append({"src": "Fundamentals",
                ...
                "sentiment": "pos", "meta": f"annual_rev_torpedo=True growth={gs_str}"})
    except Exception:
        pass
    ...
    try:
        ...
        if float_shares and float_shares > 0 and shares_short:
            ...
            if sf > 20:
                ...
                result.score += 9
                result.rationale.append({"src": "Short Interest",
                    ...
                    "sentiment": "pos", "meta": f"short_float_polygon={sf:.1f}%"})
    except Exception:
        pass
    ...
    if massive_sigs:
        ...
        if sv > 55:
            ...
            result.rationale.append({"src": "Dark Pool",
                ...
                "sentiment": "pos", "meta": "Short Volume"})
        ...
        if gex_val > 1_000_000:
            ...
            result.rationale.append({"src": "Options",
                ...
                "sentiment": "neg", "meta": f"net_gex={gex_val:,.0f}"})
...
async def institutional_worker(
    ...
    if insider and insider.get("filings", 0) > 0:
        ...
        if abs(iscore) >= 4:
            ...
            if iscore > 0:
                result.rationale.append({"src": "SEC EDGAR",
                    ...
                    "sentiment": "pos", "meta": f"Net shares: +{net:,} | Filings: {n_fv}"})
            else:
                result.rationale.append({"src": "SEC EDGAR",
                    ...
                    "sentiment": "neg", "meta": f"Net shares: {net:,} | Filings: {n_fv}"})
    ...
    if inst:
        ...
        if abs(fund_score) >= 4:
            ...
            if fund_score > 0:
                result.rationale.append({"src": "13F",
                    ...
                    "sentiment": "pos", "meta": f"13F qoq={qoq} score={fund_score:+.0f}"})
            else:
                result.rationale.append({"src": "13F",
                    ...
                    "sentiment": "neg", "meta": f"13F qoq={qoq} score={fund_score:+.0f}"})
...
async def sentiment_worker(
    ...
    if social:
        ...
        if bull_pct >= 70:
            ...
            result.rationale.append({"src": "Social",
                ...
                "sentiment": "pos", "meta": f"StockTwits bull: {bull_pct:.0f}%"})
        elif bull_pct <= 30:
            result.score -= 5
            result.sources.add("Social")
            result.rationale.append({"src": "Social",
                ...
                "sentiment": "neg", "meta": f"StockTwits bull: {bull_pct:.0f}%"})
        ...
        if wsb_v > 2.0:
            ...
            result.rationale.append({"src": "Social",
                ...
                "sentiment": "pos", "meta": f"WSB velocity: {wsb_v:.1f}×"})
    ...
    if congress:
        ...
        if abs(c_score) >= 4:
            ...
            result.rationale.append({"src": "Congress",
...
ALL_WORKERS = [news_worker, fundamentals_worker, options_worker,
