...
_CUSIP_MAP: dict[str, str] = {
    ...
    "02079K305": "GOOGL","30303M102": "META", "88160R101": "TSLA",
    "67066G104": "NVDA", "922908363": "V",    "57636Q104": "MA",
    "46625H100": "JPM",  "172967424": "CRM",  "69608A108": "ORCL",
    "742718109": "PG",   "478160104": "JNJ",  "931427108": "UNH",
    "911312106": "UPS",  "732834107": "PFE",  "857477103": "STZ",
    "079879106": "BRK-B","91822M106": "V",    "345370860": "AMD",
    "78486M107": "S&P",  "12504L109": "COP",
    "458140100": "INTC", "883556102": "TM",   "66987V109": "NVO",
    "025816109": "AXP",
}
...
async def get_institutional_signals(watchlist: list[str]) -> list[dict]:
    ...
    for r in results:
        ...
        if t not in by_ticker:
            by_ticker[t] = {"ticker": t, "score": 0, "rationale_items": [], "funds": [], "actions": [], "qoq_trends": []}
