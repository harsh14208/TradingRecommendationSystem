...
async def test_get_option_chain_signals_success():
    ...
    mock_resp.json.return_value = {
        "results": [
            # ATM options
            {"strike_price": 100, "contract_type": "call", "open_interest": 1000, "greeks": {"gamma": 0.05, "delta": 0.5}, "implied_volatility": 0.3},
            {"strike_price": 100, "contract_type": "put", "open_interest": 500, "greeks": {"gamma": 0.05, "delta": -0.5}, "implied_volatility": 0.35},
            # 25-delta options for skew
            {"strike_price": 110, "contract_type": "call", "open_interest": 100, "greeks": {"gamma": 0.01, "delta": 0.25}, "implied_volatility": 0.25},
            {"strike_price": 90, "contract_type": "put", "open_interest": 100, "greeks": {"gamma": 0.01, "delta": -0.25}, "implied_volatility": 0.35},
        ]
    }

    with patch("services.massive_options.os.getenv", return_value="TEST_KEY"), \
