...
def _snap(win_rate=60.0, sharpe=5.0, avg=2.5, max_dd=2.0,
          phantom=10, stop_enforced_wr=55.0, brier=0.28):
    return {
        "returns": {"win_rate": win_rate, "avg": avg, "pf": 3.0, "kelly": 39.0},
        "risk":    {"sharpe": sharpe, "sortino": 12.0, "max_dd": max_dd,
                    "calmar": 300.0, "omega": 3.0, "recovery": 500.0, "ulcer": 0.5},
        "tail":    {"var_95": 6.8, "var_99": 10.0, "cvar_95": 8.7, "sigma": 7.0},
        "distribution": {"skew": 1.2, "kurt": 2.3, "t_stat": 8.0, "p_value": 0.0,
                         "brier": brier, "max_win_streak": 16, "max_loss_streak": 8},
        "trade_path": {"phantom_wins": phantom, "stop_enforced_wr": stop_enforced_wr,
                       "hit_stop_pct": 45.0, "hit_target_pct": 38.0,
                       "avg_mae": -6.0, "avg_mfe": 10.5, "capture_ratio": 0.41},
