...
async def portfolio_risk():
    ...
    from services.alpaca_rest import get_positions, get_account
    ...
    if not positions:
        return {"positions": 0, "total_exposure": 0, "beta": None,
                "sharpe": None, "max_drawdown": None, "risk_level": "none"}
    ...
    risk_level = "low"
    if avg_beta is not None and avg_beta > 1.5: risk_level = "high"
    elif avg_beta is not None and avg_beta > 1.0: risk_level = "medium"
    if sharpe is not None and sharpe < 0: risk_level = "high"
