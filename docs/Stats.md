...
## 15. Project Ratings — v8.6 (2026-06-11)
...
| **Test Coverage** | 7.9/10 | B+ | ↑ from 7.7 (v8.5) | **R10-18 partial:** `test_r10_hardening.py` adds regression guards for both audit bugs. **v8.5:** §69–§74 gate unit tests added (`tests/test_gates_5982.py`, all passing); SPRT monitor 12 tests; E2E framework installed (5 passed, 7 skipped). Still open: true end-to-end "scan persists against real Postgres" test; TEST-4 mutation testing (>70%). Prior v8.3 finding: no test asserted ML training-feature NaN rates or train/serve distribution parity — the meta-model skew shipped green. |
