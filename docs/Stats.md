...
> **§44 — Alpha Decomp Rerun v12-105T (2026-05-28):** Signal alpha decomp rerun post-§43 fixes on expanded 105-ticker universe (OSC×1.0 + MR×0.5 + 8 quality filters + RS_QUALITY). Key finding: **105-ticker v12 Sharpe=−0.19 (N=81, WR=54.3%, Avg −0.56%)** vs curated **v2 Sharpe=0.43 (N=77, WR=66.2%, Avg +1.45%)**. Technical ceiling v4-opt: Sharpe=0.49 (N=10). Confirms signal edge is universe-specific: ~30% of S&P 500 members dilute the MR factor. v2's 77-ticker curated set (≥3 trades/23yr under strict BB%B + IBS + VWAP gates) retains the edge; uncurated expansion destroys it. **Action: keep curated 48-ticker live universe; do not expand without per-ticker backtest validation.**
